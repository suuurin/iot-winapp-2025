namespace SyntaxWinApp02
{
    public partial class FrmMain : Form
    {
        ...
        private void BtnCheck_Click(object sender, EventArgs e)
        {
            ...
            List<int> numbers = [4, 10, 1, 5, 3, 7, 6, 8, 9, 2];
            ...
            // 기본 LinQ 방식 > 3줄로 위의 전통방식을 정리
            numbers = [14, 20, 11, 15, 18, 19, 16, 13, 12, 17];
            var resList2 = from n in numbers where n % 2 == 0 orderby n select n;
            TxtLog.Text += "링큐1 정렬리스트 > " + string.Join(" ", resList2) + "\r\n";

            // LINQ Method Chaining > 위보다 더 짧게 가능
